...
const EVENT_META = {
  ...
  'retrieval.started':     { icon: Circle,        color: 'text-primary-400', label: 'Retrieval started' },
  'retrieval.completed':   { icon: CheckCircle2,  color: 'text-blue-400',    label: 'Retrieval completed' },
  'reranking.completed':   { icon: CheckCircle2,  color: 'text-blue-400',    label: 'Reranking completed' },
  'generation.started':    { icon: Circle,        color: 'text-primary-400', label: 'Generation started' },
  'generation.completed':  { icon: CheckCircle2,  color: 'text-blue-400',    label: 'Generation completed' },
  'claims.extracted':      { icon: CheckCircle2,  color: 'text-indigo-400',  label: 'Claims extracted' },
  'verification.completed':{ icon: CheckCircle2,  color: 'text-indigo-400',  label: 'Verification completed' },
  'integrity.completed':   { icon: CheckCircle2,  color: 'text-indigo-400',  label: 'Integrity analysis' },
  'diagnosis.completed':   { icon: AlertTriangle, color: 'text-amber-400',   label: 'Diagnosis completed' },
  'recovery.started':      { icon: RefreshCw,     color: 'text-amber-400',   label: 'Recovery started' },
  'recovery.completed':    { icon: CheckCircle2,  color: 'text-amber-400',   label: 'Recovery completed' },
  'reverification.completed':{ icon: CheckCircle2, color: 'text-green-400',  label: 'Re-verification' },
