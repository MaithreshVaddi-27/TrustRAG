...
const EVENT_META = {
  ...
  'retrieval.started':     { icon: Circle,        color: 'text-cyan-400',    label: 'Hybrid retrieval started' },
  'retrieval.empty':       { icon: AlertTriangle, color: 'text-amber-400',   label: 'Knowledge base empty' },
  ...
  'generation.started':    { icon: Circle,        color: 'text-sky-400',     label: 'Grounded generation started' },
  'generation.completed':  { icon: CheckCircle2,  color: 'text-sky-400',     label: 'Generation completed' },
  'claims.started':        { icon: Circle,        color: 'text-primary-400', label: 'Claim decomposition started' },
  'claims.decomposed':     { icon: CheckCircle2,  color: 'text-primary-400', label: 'Claims decomposed' },
  'claims.verified':       { icon: CheckCircle2,  color: 'text-emerald-400', label: 'Claims verified' },
  'verification.started':  { icon: Circle,        color: 'text-cyan-400',    label: 'NLI verification started' },
  'verification.completed':{ icon: CheckCircle2,  color: 'text-emerald-400', label: 'Verification completed' },
