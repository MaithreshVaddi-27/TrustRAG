...
> 2. **Option B (Public Git URL)**: Click **New +** → **Web Service** → paste public URL `https://github.com/MaithreshVaddi-27/TrustRAG` → select branch `production-deploy` (no GitHub account linking required!).
...
3. Select your repository: `TrustRAG` (branch: `production-deploy`).
